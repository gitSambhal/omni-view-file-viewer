    ...
    <div className="flex flex-col flex-1 h-full min-h-0 min-w-0 bg-slate-900 text-slate-100 overflow-hidden">
      ...
      <div className="flex items-center justify-between p-3 bg-slate-800 border-b border-slate-700 gap-2">
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center bg-slate-950 p-0.5 rounded border border-slate-700">
            <button
              ...
              className={`flex items-center gap-1 px-2.5 py-1 rounded text-xs font-medium transition-colors ${
                mode === 'preview' ? 'bg-purple-600 text-white' : 'text-slate-400 hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-1 px-2.5 py-1 rounded text-xs font-medium transition-colors ${
                mode === 'split' ? 'bg-purple-600 text-white' : 'text-slate-400 hover:text-white'
              }`}
            >
            ...
            <button
              onClick={() => setMode('raw')}
              className={`flex items-center gap-1 px-2.5 py-1 rounded text-xs font-medium transition-colors ${
                mode === 'raw' ? 'bg-purple-600 text-white' : 'text-slate-400 hover:text-white'
              }`}
            >
          ...
          <button
            onClick={handleCopy}
            className="flex items-center gap-1.5 bg-slate-700 hover:bg-slate-600 text-slate-200 px-2.5 py-1 rounded text-xs transition-colors"
          >
